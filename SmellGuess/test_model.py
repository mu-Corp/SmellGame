...
#Lance un interpréteur local pour tester les objets
...
# Enregistrement des individus ds la bdd
...
spl_17 = Sample(name='d10',refOdor = False)
...
#Recuperation des smeller
for elt in Smeller.objects.filter(smeller=True):
	print "Name :", elt.name
